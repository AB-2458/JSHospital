    ...
    <section className="relative pt-40 pb-24 bg-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <span className="text-white text-sm font-bold tracking-wide uppercase">25 Years of Medical Excellence</span>
        </motion.div>
        ...
        >
          Since 2001, Clinical Sanctuary has been at the forefront of healthcare in India, combining advanced medical technology with a patient-first philosophy.
        </motion.p>

        {/* Stats Infographic */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { label: 'Specialists', value: '500+', icon: Users },
            { label: 'Beds Capacity', value: '1200+', icon: Building2 },
            { label: 'Success Rate', value: '99.2%', icon: Activity },
            { label: 'Research Papers', value: '1500+', icon: Microscope },
          ].map((stat, i) => (
            <motion.div 
              key={i}
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                To provide compassionate, accessible, and high-quality healthcare that empowers our patients and communities. We strive to be the sanctuary where medical excellence meets human empathy.
              </p>
            </div>
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-lg text-white/60 leading-relaxed">
                To be the global benchmark for clinical excellence and patient-centric care. We envision a future where advanced medicine is delivered with the warmth and trust of a sanctuary.
              </p>
            </div>
...
const Leadership = () => {
  const leaders = [
    { name: 'Dr. Rajesh Khanna', role: 'Medical Director', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=400&h=500' },
    { name: 'Dr. Meera Vasudevan', role: 'Chief of Surgery', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?auto=format&fit=crop&q=80&w=400&h=500' },
    { name: 'Mr. Arvind Swamy', role: 'CEO', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400&h=500' },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-10">
              Our sanctuary is designed to facilitate healing through modern architecture and advanced medical technology. Every corner is optimized for patient comfort and safety.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                { title: 'Green Campus', desc: 'Eco-friendly design promoting a healing atmosphere.', icon: Heart },
    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500">
          {['NABH', 'JCI', 'NABL', 'ISO 9001', 'Green Hospital'].map((item) => (
      ...
      <section className="py-24 bg-primary relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-display font-extrabold text-white mb-8">
            Experience the Sanctuary Care Today.
          </h2>
